...
func (c *Component) CreateJobFailureIncident(
	ctx context.Context,
	jobKey, elementID, processInstanceID, message string,
	retries int,
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
...
func (c *Component) CreateBPMNErrorIncident(
	ctx context.Context,
	elementID, processInstanceID, errorCode, message string,
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
	}
...
func (c *Component) CreateExpressionErrorIncident(
	ctx context.Context,
	elementID, processInstanceID, expression, message string,
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
	}
...
func (c *Component) CreateTimerErrorIncident(
	ctx context.Context,
	timerID, elementID, processInstanceID, message string,
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
	}
...
func (c *Component) CreateMessageErrorIncident(
	ctx context.Context,
	messageName, correlationKey, processInstanceID, message string,
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
	}
...
func (c *Component) CreateIncidentFromJobError(
	ctx context.Context,
	jobKey, jobType, workerID, elementID, processInstanceID, errorMessage string,
	retries int,
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
	}
	return c.manager.CreateIncidentFromJobError(
		ctx,
		jobKey, jobType, workerID, elementID, processInstanceID, errorMessage,
		retries,
	)
}
...
func (c *Component) CreateIncidentFromBPMNError(
	ctx context.Context,
	elementID, elementType, processInstanceID, processKey, errorCode, errorMessage string,
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
	}
	return c.manager.CreateIncidentFromBPMNError(
		ctx,
		elementID, elementType, processInstanceID, processKey, errorCode, errorMessage,
	)
}

// CreateIncidentFromTimerError creates incident from timer error details
// Создает инцидент на основе деталей ошибки таймера
func (c *Component) CreateIncidentFromTimerError(
	ctx context.Context,
	timerID, elementID, processInstanceID, timerType, errorMessage string,
	scheduledAt interface{},
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
	}
	return c.manager.CreateIncidentFromTimerError(
		ctx,
		timerID, elementID, processInstanceID, timerType, errorMessage,
		scheduledAt,
	)
}
...
func (c *Component) CreateIncidentFromExpressionError(
	ctx context.Context,
	elementID, processInstanceID, expression, context, errorMessage string,
) (*Incident, error) {
	if err := c.checkReady(); err != nil {
		return nil, err
	}
	return c.manager.CreateIncidentFromExpressionError(
		ctx,
		elementID, processInstanceID, expression, context, errorMessage,
	)
}
...
// Повторяет инцидент
func (c *Component) RetryIncident(
	ctx context.Context,
...
// Отклоняет инцидент
func (c *Component) DismissIncident(
	ctx context.Context,
...
func (c *Component) RetryJobIncident(
	ctx context.Context,
	incidentID, resolvedBy string,
	newRetries int,
) (*Incident, error) {
...
func (c *Component) DismissBPMNErrorIncident(
	ctx context.Context,
...
func (c *Component) ResolveByType(
	ctx context.Context,
...
func (c *Component) ResolveByProcessInstance(
	ctx context.Context,
	...
	return c.manager.ResolveByProcessInstance(
		ctx,
		processInstanceID,
		action,
		resolvedBy,
