...
func (c *Component) CorrelateMessage(ctx context.Context, tenantID, messageName, correlationKey, processInstanceID string, variables map[string]interface{}) (*models.MessageCorrelationResult, error) {
	c.logger.Info("Correlating message", logger.String("messageName", messageName), logger.String("correlationKey", correlationKey), logger.String("processInstanceId", processInstanceID))
...
func (c *Component) CreateMessageSubscription(ctx context.Context, subscription *models.ProcessMessageSubscription) error {
...
func (c *Component) ListMessageSubscriptions(ctx context.Context, tenantID string, limit, offset int) ([]*models.ProcessMessageSubscription, error) {
...
func (c *Component) GetMessageSubscription(ctx context.Context, subscriptionID string) (*models.ProcessMessageSubscription, error) {
...
func (c *Component) ListBufferedMessages(ctx context.Context, tenantID string, limit, offset int) ([]*models.BufferedMessage, error) {
...
func (c *Component) ProcessMessage(ctx context.Context, messageJSON string) error {
	...
	c.logger.Debug("Processing message request", logger.String("type", request.Type), logger.String("request_id", request.RequestID))
...
func (c *Component) handlePublishMessage(ctx context.Context, request MessageRequest) error {
	...
	if err := mapToStruct(request.Payload, &payload); err != nil {
		response := CreateMessageErrorResponse("publish_message_response", request.RequestID, fmt.Sprintf("invalid payload: %v", err))
...
func (c *Component) handleCorrelateMessage(ctx context.Context, request MessageRequest) error {
	...
	if err := mapToStruct(request.Payload, &payload); err != nil {
		response := CreateMessageErrorResponse("correlate_message_response", request.RequestID, fmt.Sprintf("invalid payload: %v", err))
		return c.sendResponse(response)
	}

	result, err := c.CorrelateMessage(ctx, payload.TenantID, payload.MessageName, payload.CorrelationKey, payload.ProcessInstanceID, payload.Variables)
...
func (c *Component) handleCreateSubscription(ctx context.Context, request MessageRequest) error {
	...
	if err := mapToStruct(request.Payload, &payload); err != nil {
		response := CreateMessageErrorResponse("create_subscription_response", request.RequestID, fmt.Sprintf("invalid payload: %v", err))
		return c.sendResponse(response)
	}
...
func (c *Component) handleDeleteSubscription(ctx context.Context, request MessageRequest) error {
	...
	if err := mapToStruct(request.Payload, &payload); err != nil {
		response := CreateMessageErrorResponse("delete_subscription_response", request.RequestID, fmt.Sprintf("invalid payload: %v", err))
		return c.sendResponse(response)
	}
...
func (c *Component) handleListSubscriptions(ctx context.Context, request MessageRequest) error {
	...
	if err := mapToStruct(request.Payload, &payload); err != nil {
		response := CreateMessageErrorResponse("list_subscriptions_response", request.RequestID, fmt.Sprintf("invalid payload: %v", err))
		return c.sendResponse(response)
	}
...
func (c *Component) handleListBufferedMessages(ctx context.Context, request MessageRequest) error {
	...
	if err := mapToStruct(request.Payload, &payload); err != nil {
		response := CreateMessageErrorResponse("list_buffered_messages_response", request.RequestID, fmt.Sprintf("invalid payload: %v", err))
		return c.sendResponse(response)
	}
...
func (c *Component) handleCleanupExpired(ctx context.Context, request MessageRequest) error {
	...
	if err := mapToStruct(request.Payload, &payload); err != nil {
		response := CreateMessageErrorResponse("cleanup_expired_response", request.RequestID, fmt.Sprintf("invalid payload: %v", err))
		return c.sendResponse(response)
	}
...
func (c *Component) handleGetStats(ctx context.Context, request MessageRequest) error {
	...
	if err := mapToStruct(request.Payload, &payload); err != nil {
		response := CreateMessageErrorResponse("get_stats_response", request.RequestID, fmt.Sprintf("invalid payload: %v", err))
		return c.sendResponse(response)
	}
...
func (c *Component) sendResponse(response MessageResponse) error {
	...
	c.logger.Debug("Sending message response", logger.String("type", response.Type), logger.String("request_id", response.RequestID))
