...
func showHelp() {
	...
	fmt.Println("  atomd incident <cmd>  - Incident management commands")
	...
	fmt.Println("  atomd job throw-error - Throw BPMN error for job")
	...
	fmt.Println("")
	fmt.Println("Incident commands:")
	fmt.Println("  atomd incident list      - List incidents")
	fmt.Println("  atomd incident show      - Show incident details")
	fmt.Println("  atomd incident resolve   - Resolve incident (retry/dismiss)")
...
func showIncidentHelp() {
	...
	fmt.Println("")
	fmt.Println("Usage:")
	fmt.Println("  atomd incident list [status] [type] [limit]                - List incidents with optional filtering")
	...
	fmt.Println("")
	fmt.Println("Examples:")
	fmt.Println("  atomd incident list                                        - List last 10 incidents")
	fmt.Println("  atomd incident list open                                   - List open incidents")
	fmt.Println("  atomd incident list open job                              - List open job failure incidents")
	fmt.Println("  atomd incident list all all 25                            - List last 25 incidents")
