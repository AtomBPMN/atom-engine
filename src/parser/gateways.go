...
func (p *GatewayParser) Parse(element *XMLElement, context *ParseContext) (map[string]interface{}, error) {
...
func (p *GatewayParser) parseGatewaySpecificConfig(element *XMLElement, gatewayType string) map[string]interface{} {
...
func (p *GatewayParser) parseExclusiveGateway(element *XMLElement) map[string]interface{} {
	config := make(map[string]interface{})
...
func (p *GatewayParser) parseParallelGateway(element *XMLElement) map[string]interface{} {
	config := make(map[string]interface{})
...
func (p *GatewayParser) parseInclusiveGateway(element *XMLElement) map[string]interface{} {
	config := make(map[string]interface{})
...
func (p *GatewayParser) parseComplexGateway(element *XMLElement) map[string]interface{} {
	config := make(map[string]interface{})
...
func (p *GatewayParser) parseEventBasedGateway(element *XMLElement) map[string]interface{} {
	config := make(map[string]interface{})
...
func (p *GatewayParser) parseExtensionElements(element *XMLElement) map[string]interface{} {
	result := make(map[string]interface{})
