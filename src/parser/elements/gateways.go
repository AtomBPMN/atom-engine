...
func (p *GatewayParser) Parse(element *parser.XMLElement, context *parser.ParseContext) (map[string]interface{}, error) {
...
func (p *GatewayParser) parseGatewaySpecificConfig(element *parser.XMLElement, gatewayType string) map[string]interface{} {
