...
func (p *TaskParser) Parse(element *parser.XMLElement, context *parser.ParseContext) (map[string]interface{}, error) {
...
func (p *TaskParser) parseScriptTask(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseServiceTask(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseUserTask(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseCallActivity(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseSubProcess(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseIOSpecification(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseDataInput(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseDataOutput(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseExtensionElements(element *parser.XMLElement) map[string]interface{} {
	result := make(map[string]interface{})
...
func (p *TaskParser) parseZeebeTaskDefinition(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseZeebeScript(element *parser.XMLElement) map[string]interface{} {
	script := make(map[string]interface{})
...
func (p *TaskParser) parseZeebeCalledElement(element *parser.XMLElement) map[string]interface{} {
...
func (p *TaskParser) parseZeebeFormDefinition(element *parser.XMLElement) map[string]interface{} {
