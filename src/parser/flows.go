...
func (p *FlowParser) Parse(element *XMLElement, context *ParseContext) (map[string]interface{}, error) {
...
func (p *FlowParser) parseSequenceFlow(element *XMLElement) map[string]interface{} {
...
func (p *FlowParser) parseMessageFlow(element *XMLElement) map[string]interface{} {
...
func (p *FlowParser) parseAssociation(element *XMLElement) map[string]interface{} {
...
func (p *FlowParser) parseExtensionElements(element *XMLElement) map[string]interface{} {
	result := make(map[string]interface{})
