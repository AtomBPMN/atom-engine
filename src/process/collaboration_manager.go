...
func (cm *CollaborationManager) CreateCollaborationMessageSubscriptions(
...
func (cm *CollaborationManager) findAllProcesses(
	bpmnProcess *models.BPMNProcess,
	currentProcessKey string,
...
func (cm *CollaborationManager) createSubscriptionsForProcess(
	bpmnProcess *models.BPMNProcess,
	processElement map[string]interface{},
	mainProcessKey string,
) error {
...
func (cm *CollaborationManager) findMessageStartEvents(
	bpmnProcess *models.BPMNProcess,
	processElement map[string]interface{},
) []string {
...
func (cm *CollaborationManager) createSubscriptionForMessageStartEvent(
	bpmnProcess *models.BPMNProcess,
	startEventID, processKey, processID string,
) error {
