...
func (ste *ServiceTaskExecutor) findBoundaryEventsForActivity(
	activityID string,
...
func (ste *ServiceTaskExecutor) createBoundaryTimerForEvent(
	token *models.Token,
	eventID string,
...
func (ste *ServiceTaskExecutor) createErrorBoundaryForEvent(
	token *models.Token,
	eventID string,
...
func (ste *ServiceTaskExecutor) extractErrorInfo(
