...
func (ps *ProcessStarter) StartProcessInstance(processKey string, variables map[string]interface{}) (*models.ProcessInstance, error) {
...
func (ps *ProcessStarter) createProcessInstance(bpmnProcess *models.BPMNProcess, processKey string, variables map[string]interface{}) *models.ProcessInstance {
...
func (ps *ProcessStarter) startExecution(instance *models.ProcessInstance, bpmnProcess *models.BPMNProcess, processKey string, variables map[string]interface{}) error {
	// Find start event
