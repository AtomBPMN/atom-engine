...
func (sm *SignalManager) Subscribe(signalName, tokenID, elementID string, cancelActivity bool, variables map[string]interface{}) error {
	sm.mutex.Lock()
...
func (sm *SignalManager) processSignalSubscription(subscription *SignalSubscription, signalVariables map[string]interface{}) error {
