...
func (bee *BoundaryEventExecutor) Execute(
	token *models.Token,
...
func (bee *BoundaryEventExecutor) handleSignalBoundaryEvent(
	...
	if bee.processComponent != nil {
		...
		err := bee.processComponent.SubscribeToSignal(
			signalName,
			token.TokenID,
...
func (bee *BoundaryEventExecutor) handleErrorBoundaryEvent(
	token *models.Token,
	element map[string]interface{},
	eventDef map[string]interface{},
	cancelActivity bool,
...
func (bee *BoundaryEventExecutor) executeRegularBoundaryEvent(
	token *models.Token,
	element map[string]interface{},
	cancelActivity bool,
) (*ExecutionResult, error) {
