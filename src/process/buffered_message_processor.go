...
func (bmp *BufferedMessageProcessor) CheckBufferedMessages(messageName, correlationKey string) (*models.BufferedMessage, error) {
...
func (bmp *BufferedMessageProcessor) findMatchingBufferedMessage(messages []*models.BufferedMessage, messageName, correlationKey string) (*models.BufferedMessage, error) {
...
func (bmp *BufferedMessageProcessor) ProcessBufferedMessage(message *models.BufferedMessage, token *models.Token) error {
...
func (bmp *BufferedMessageProcessor) CorrelateMessage(messageName, correlationKey, processInstanceID string, variables map[string]interface{}) (*models.MessageCorrelationResult, error) {
	messagesComponent := bmp.core.GetMessagesComponent()
	if messagesComponent == nil {
		return nil, fmt.Errorf("messages component not available")
	}
