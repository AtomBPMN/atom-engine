...
func (se *StartEventExecutor) handleMessageStartEvent(
	token *models.Token,
...
func (se *StartEventExecutor) handleTimerStartEvent(
	token *models.Token,
	element map[string]interface{},
	eventDef map[string]interface{},
) (*ExecutionResult, error) {
...
func (se *StartEventExecutor) handleSignalStartEvent(
	token *models.Token,
	element map[string]interface{},
	eventDef map[string]interface{},
) (*ExecutionResult, error) {
...
func (se *StartEventExecutor) executeRegularStartEvent(
	token *models.Token,
	element map[string]interface{},
) (*ExecutionResult, error) {
	// Get outgoing sequence flows
