...
func (icmh *IntermediateCatchMessageHandler) HandleMessageEvent(
	token *models.Token,
...
func (icmh *IntermediateCatchMessageHandler) extractCorrelationKeyFromMessage(
	token *models.Token,
	messageName string,
) string {
...
func (icmh *IntermediateCatchMessageHandler) proceedToNextElements(
	element map[string]interface{},
) (*ExecutionResult, error) {
	// Get outgoing flows
...
func (icmh *IntermediateCatchMessageHandler) evaluateCorrelationKeyExpression(
