...
func (ps *ProcessStarter) handleMessageStartEvent(
	instance *models.ProcessInstance,
	bpmnProcess *models.BPMNProcess,
	startEventID, processKey string,
...
func (ps *ProcessStarter) handleRegularStartEvent(
	instance *models.ProcessInstance,
	processKey, startEventID string,
) error {
...
func (ps *ProcessStarter) createMessageStartEventSubscription(
	bpmnProcess *models.BPMNProcess,
	startEventID, processKey string,
	variables map[string]interface{},
) error {
