...
func (rte *ReceiveTaskExecutor) findBoundaryEventsForActivity(
	activityID string,
...
func (rte *ReceiveTaskExecutor) createBoundaryTimerForEvent(
	token *models.Token,
	eventID string,
...
func (rte *ReceiveTaskExecutor) createErrorBoundaryForEvent(
	token *models.Token,
	eventID string,
