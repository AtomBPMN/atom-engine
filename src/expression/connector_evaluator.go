...
func (cee *ConnectorExpressionEvaluator) EvaluateStringParameter(paramName, value string, variables map[string]interface{}) interface{} {
...
func (cee *ConnectorExpressionEvaluator) EvaluateConnectorParameters(connectorParams, processVariables map[string]interface{}) map[string]interface{} {
...
func (cee *ConnectorExpressionEvaluator) evaluateFeelExpression(paramName, expression string, variables map[string]interface{}) interface{} {
...
func (cee *ConnectorExpressionEvaluator) evaluateJSONString(paramName, jsonStr string, variables map[string]interface{}) interface{} {
