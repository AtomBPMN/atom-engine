...
func (eh *EvaluationHelper) EvaluateConditionWithVariables(variables map[string]interface{}, condition string) (bool, error) {
	if variables == nil {
		variables = make(map[string]interface{})
	}
...
func (eh *EvaluationHelper) EvaluateExpression(expression string, variables map[string]interface{}) (interface{}, error) {
	if variables == nil {
		variables = make(map[string]interface{})
	}
...
func (eh *EvaluationHelper) EvaluateExpressionEngine(expression interface{}, variables map[string]interface{}) (interface{}, error) {
	if variables == nil {
		variables = make(map[string]interface{})
	}
