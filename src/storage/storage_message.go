...
func (bs *BadgerStorage) SaveProcessMessageSubscription(
	ctx context.Context,
...
func (bs *BadgerStorage) GetProcessMessageSubscription(
	ctx context.Context,
...
func (bs *BadgerStorage) ListProcessMessageSubscriptions(
	ctx context.Context,
	tenantID string,
	limit, offset int,
) ([]*models.ProcessMessageSubscription, error) {
...
func (bs *BadgerStorage) ListBufferedMessages(
	ctx context.Context,
	tenantID string,
	limit, offset int,
...
func (bs *BadgerStorage) SaveMessageCorrelationResult(
	ctx context.Context,
...
func (bs *BadgerStorage) ListMessageCorrelationResults(
	ctx context.Context,
	tenantID, messageName, processKey string,
	limit, offset int,
