...
type MessagesComponentTypedInterface interface {
	...
	PublishMessageTyped(
		ctx context.Context,
		req *types.MessagePublishRequest,
	) (*types.MessagePublishResponse, error)
	ListBufferedMessagesTyped(
		ctx context.Context,
		req *types.BufferedMessageListRequest,
	) (*types.BufferedMessageListResponse, error)
	ListMessageSubscriptionsTyped(
		ctx context.Context,
		req *types.MessageSubscriptionListRequest,
	) (*types.MessageSubscriptionListResponse, error)
	CleanupExpiredMessagesTyped(
		ctx context.Context,
		req *types.MessageCleanupRequest,
	) (*types.MessageCleanupResponse, error)
