...
func (s *processServiceServer) StartProcessInstance(
	ctx context.Context,
	req *processpb.StartProcessInstanceRequest,
) (*processpb.StartProcessInstanceResponse, error) {
...
func (s *processServiceServer) GetProcessInstanceStatus(
	ctx context.Context,
	req *processpb.GetProcessInstanceStatusRequest,
) (*processpb.GetProcessInstanceStatusResponse, error) {
...
func (s *processServiceServer) CancelProcessInstance(
	ctx context.Context,
	req *processpb.CancelProcessInstanceRequest,
) (*processpb.CancelProcessInstanceResponse, error) {
...
func (s *processServiceServer) ListProcessInstances(
	ctx context.Context,
	req *processpb.ListProcessInstancesRequest,
) (*processpb.ListProcessInstancesResponse, error) {
...
func (s *processServiceServer) ListTokens(
	ctx context.Context,
	req *processpb.ListTokensRequest,
) (*processpb.ListTokensResponse, error) {
	// Set defaults for pagination and sorting parameters
	pageSize := req.PageSize
	if pageSize <= 0 {
		pageSize = 20 // Default page size
...
func (s *processServiceServer) GetTokenStatus(
	ctx context.Context,
	req *processpb.GetTokenStatusRequest,
) (*processpb.GetTokenStatusResponse, error) {
...
func (s *processServiceServer) GetProcessInstanceInfo(
	ctx context.Context,
	req *processpb.GetProcessInstanceInfoRequest,
) (*processpb.GetProcessInstanceInfoResponse, error) {
