...
func (s *incidentsServiceServer) CreateIncident(
	ctx context.Context,
	req *incidentspb.CreateIncidentRequest,
) (*incidentspb.CreateIncidentResponse, error) {
...
func (s *incidentsServiceServer) ResolveIncident(
	ctx context.Context,
	req *incidentspb.ResolveIncidentRequest,
) (*incidentspb.ResolveIncidentResponse, error) {
...
func (s *incidentsServiceServer) GetIncident(
	ctx context.Context,
	req *incidentspb.GetIncidentRequest,
) (*incidentspb.GetIncidentResponse, error) {
...
func (s *incidentsServiceServer) ListIncidents(
	ctx context.Context,
	req *incidentspb.ListIncidentsRequest,
) (*incidentspb.ListIncidentsResponse, error) {
...
func (s *incidentsServiceServer) GetIncidentStats(
	ctx context.Context,
	req *incidentspb.GetIncidentStatsRequest,
) (*incidentspb.GetIncidentStatsResponse, error) {
